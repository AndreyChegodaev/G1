...
public class IntObjManager_Page35 : MonoBehaviour
{
    ...
    private void Update()
    {
        if (TextManager_Page35.instance.paragraphs[TextManager_Page35.instance.paragraphs.Count-1].GetComponent<TMPro.TextMeshProUGUI>().enabled == true)
        {
            flag = true;
        }
    }
