...
public class IntObjManager_Page8 : MonoBehaviour 
{
    ...
    private void Update()
    {
        ...
        if (TextManager_Page8.instance.paragraphs[TextManager_Page8.instance.paragraphs.Count - 1].GetComponent<TMPro.TextMeshProUGUI>().enabled == true)
        {
            flag = true;
        }
    }
